...
class McSAS3_cli_opt:
    ...
    def fileExists(self, attribute, value):
        assert value.exists(), "input data file {value} must exist"
    ...
    def run(self):
        ...
        mh = McHat.McHat(seed=None, resultIndex=self.resultIndex, nThreads=self.nThreads ,**optDict)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="The number (n>0) of cores/threads used for optimization. If omitted, the value from the config file is used (default). Never more threads are used as cores exist.",
        # required=True,
    )
    parser.add_argument(
        "-d",
